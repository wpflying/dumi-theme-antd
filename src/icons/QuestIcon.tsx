...
<svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <title>常见问题</title>
    <defs>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="linearGradient-A">
            ...
            <g id="编组-7备份-2" transform="translate(1181.000000, 421.000000)">
                <g id="常见问题" transform="translate(26.000000, 15.000000)">
                    ...
                    <g id="编组-35" transform="translate(0.000000, 1.000000)">
                        <rect id="矩形备份-9" fill="url(#linearGradient-A)" x="13.0285714" y="9.8" width="10.9714286" height="11.2" rx="1.71428571"></rect>
...
const QuestIcon: React.FC<{ className?: string }> = (props) => (
